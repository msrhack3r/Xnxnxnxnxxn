...
module.exports = {
  ...
  onStart: async function ({ api, args, message, event }) {
    ...
    const cookie = 'cwh5ED4cpxA4E-oMcs24LsX7DvEGw7SMLd8XqMv_oNiSHdMuPY2eRK4NSFbxEeDAEpAfcQ.'; //if you don't know know how to get cookie from cookies editor then just don't add the cookie parameter with api params ( it will use my default cookie ) . but i recommend  add your own cookies for less error. 

    const key = 'SiAM_MNQGD'; // Add your  API key here ( get it from SiAM)


    let params = {
      prompt: encodeURIComponent(prompt),
      cookie: encodeURIComponent(cookie),//if you add cookies don't encode the cookie. Exact same as cookies editor " __Secure-1PSID " value .
